            ...
            <div className="flex items-center justify-center w-full min-h-screen bg-gray-100">
                <div className="flex flex-col text-gray-700 lg:flex-row lg:space-x-16 lg:space-x-reverse">
                    ...
                    <div className="max-w-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2395 1800" className="w-full max-w-sm"
                             width="400">
                            <path
                            ...
                            <path className="cls-5" fill={"#4ea7f1"} stroke={"#000"}
                            ...
                            <path className="cls-6" fill={"#f8f3ed"} stroke="#000" strokeMiterlimit="10"
                            ...
                            <path className="cls-5" fill="#4ea7f1" stroke="#000" strokeMiterlimit="10"
                            ...
                            <path className="cls-7" fill="#333" stroke="#000" strokeMiterlimit="10"
                            ...
                            <path className="cls-8" fill="#333" stroke="#000" strokeMiterlimit="10"
                            ...
                            <ellipse className="cls-7" cx="1452.5" cy="998.5" rx="153" ry="117"  fill="#333" stroke="#000" strokeMiterlimit="10"/>
                            <circle className="cls-9" cx="1355" cy="991" r="31.5"  fill="#f8f59c" stroke="#000" strokeMiterlimit="10"/>
                            <path className="cls-10"  fill="#f3d2c9" stroke="#000" strokeMiterlimit="10"
